...
match.it <- matchit(DCB_DES ~ Age+ Sex + PMHx_AF+ FHx_CAD+ Tash_Bif+ Diffuse_Dx+ Tortuosity+ denovo_LesionLgth+ denovo_VesselDiam, data = NSTEMI_PS_Mort,  method="genetic", replace = T,  pop.size = 500)
a <- summary(match.it)
...
match.it <- matchit(DCB_DES ~ Age+ Sex + PMHx_AF+ FHx_CAD+ Diffuse_Dx+ Tortuosity+ denovo_LesionLgth+ denovo_VesselDiam, data = NSTEMI_PS_Mort,  method="genetic", replace = T,  pop.size = 500)
a <- summary(match.it)
...
match.it <- matchit(DCB_DES ~ Age + PMHx_AF+ FHx_CAD+ Tash_Bif+ Diffuse_Dx+ Tortuosity+ denovo_LesionLgth+ denovo_VesselDiam, data = NSTEMI_PS_Mort,  method="genetic", replace = T,  pop.size = 500)
a <- summary(match.it)
